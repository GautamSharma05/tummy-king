...
export default function Home() {
  return (
    <>
      ...
      <section>
        <h1 className="text-3xl text-center"><span className="text-primary">Menu</span> That <span className="text-[#FDC55E]">Always</span> Make You Fall In <span className="text-primary">Love</span></h1>
      </section>
    </>
  );
}
